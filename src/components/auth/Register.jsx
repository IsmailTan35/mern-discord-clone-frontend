...
const Register = () => {
  ...
  return (
    <>
      <div
        style={{ borderColor: "rgba(32, 34, 37, 0.5)", borderStyle: "solid" }}
      ></div>
      <div className="register-wrapper">
        ...
        <div className="register-term-wrapper">
          ...
          <p className="register-term-text">
            (İsteğe bağlı) Discord güncellemeleri, ipuçları ve özel teklifler
            için e-posta almak istiyorum. Bundan istediğin zaman
            vazgeçebilirsin.
          </p>
        </div>

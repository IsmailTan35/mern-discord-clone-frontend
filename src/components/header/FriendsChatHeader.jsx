    ...
    <>
      ...
      <div className="header-friend-right-wrapper">
        <OverlayTrigger
          ...
          delay={delay}
          overlay={props => (
            <Tooltip {...props}>{`Sesli Arama Başlat`}</Tooltip>
          )}
        >
          <div
            onClick={() => {
        ...
        <OverlayTrigger
          ...
          delay={delay}
          overlay={props => (
            <Tooltip {...props}>{`Görüntülü Arama Başlat`}</Tooltip>
          )}
        >
          <div
            onClick={() => {
        ...
        <OverlayTrigger
          ...
          delay={delay}
          overlay={props => (
            <Tooltip {...props}>{`Sabitlenmiş Mesajlar`}</Tooltip>
          )}
        >
          <div>
            <svg
        ...
        <OverlayTrigger
          placement="bottom"
          delay={delay}
          overlay={props => <Tooltip {...props}>{`Genel Kutusu`}</Tooltip>}
        >
          <div>
            <svg
              x="0"
        ...
        <OverlayTrigger
          placement="bottom"
          delay={delay}
          overlay={props => <Tooltip {...props}>{`Yardım`}</Tooltip>}
        >
          <div>
            <svg
              x="0"

	...
	return (
		<>
			<div style={{minWidth:"100%"}}>
				...
				<button className='modal-create-button' onClick={(e)=>{e.preventDefault()}}>
					<div className='modal-create-button-content'>
						<div>
							<img src="/assets/img/joinserver-1.svg" alt=""/>
						</div>
						<div>
							<div className='modal-create-button-content-text' style={{display:"flex"}}>
				...
				<div className='modal-secondRow' style={{background:"#f2f3f5",display:"flex",justifyContent:"space-between"}}>

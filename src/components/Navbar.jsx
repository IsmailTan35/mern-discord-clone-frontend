...
const Navbar = ()=>{
    ...
    const changeHistory = (id)=>{
        const firstChannel = serverList.find(server=>server._id===id).channels[0]
        navigate("/channels/"+id+"/"+firstChannel._id)
    }
    ...
    return(
        ...
        <div className="navbar-wrapper">
            ...
            <OverlayTrigger
                ...
                >
                <div className={`navbarCircle${!["/channels/@me","/store"].every((e)=>!location.pathname.includes(e)) ?" active":""}`} 
                    ...
                    serverList.map((server,i)=>{
                        return(
                            ...
                            <OverlayTrigger
                                ...
                                >
                                <div className={`navbarCircle${location.pathname.split("/")[2]===server._id?" active":""}`} 
                                    onClick={()=>{changeHistory(server._id)}}>

...
const Waiting = () => {
    ...
    const handleAccept = (user) => {
        socket.emit("acceptFriendRequest",user)
    }
        ...
        <>
        {
            friendsRequest && friendsRequest.length>0 ? <>
                <div className='friends-online-text-wrapper'>
                    {`${"BEKLEYEN İSTEKLER - "}${friendsRequest.length>0?friendsRequest.length:""}`}
                </div>
            {
                friendsRequest.map((friend,index) => {
                    return (
                        <div className='friends-users-list-item-wrapper' key={index} onClick={()=>{}}>
                            <div className='friends-users-list-item'>
                                <div className="friends-users-list-item-avatar">
                                    ...
                                    <div className="friends-users-list-item-state">
                                ...
                                <div className="friends-users-list-item-buttons">
                                    {
                                        ...
                                        <>
                                            <div onClick={()=>{handleAccept(friend)}}>
                                                <svg viewBox="0 0 20 20" fill="none">
                                                    <path fill="hsl(218, calc(var(--saturation-factor, 1) * 4.6%), 46.9%)" d="M7.89561 14.8538L6.30462 13.2629L14.3099 5.25755L15.9009 6.84854L7.89561 14.8538Z"></path>
                                                    <path fill="hsl(218, calc(var(--saturation-factor, 1) * 4.6%), 46.9%)" d="M4.08643 11.0903L5.67742 9.49929L9.4485 13.2704L7.85751 14.8614L4.08643 11.0903Z"></path>
                                                </svg>
                                            </div>
                                            <div onClick={()=>{handleReject(friend)}}>
                                                <svg viewBox="0 0 20 20" fill="none" >
                                                    <path width={25} height={25} fill="hsl(218, calc(var(--saturation-factor, 1) * 4.6%), 46.9%)" d="M5.13231 6.72963L6.7233 5.13864L14.855 13.2704L13.264 14.8614L5.13231 6.72963Z">
                                                        ...
                                                        <path fill="hsl(218, calc(var(--saturation-factor, 1) * 4.6%), 46.9%)" d="M13.2704 5.13864L14.8614 6.72963L6.72963 14.8614L5.13864 13.2704L13.2704 5.13864Z">
                                                    </path>
                                                </svg>
                                            </div>
            ...
            <div className="friends-empty">
                {`Bekleyen arkadaşlık isteği yok. Şimdilik işte Wumpus.`}
            </div>
            }
        </>)
}
